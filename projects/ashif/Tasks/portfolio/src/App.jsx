              ...
              <>
                <section id="home" className="min-h-screen flex flex-col items-center justify-center bg-gray-100 rounded-lg shadow-md p-8 mb-8 space-y-6 opacity-0 animate-fadeIn">
                  ...
                  <p className="text-lg max-w-3xl text-center">
                    I am Ashif, a passionate software engineer specializing in building scalable web applications using React, Node.js, and modern JavaScript frameworks. Explore my projects, skills, and get in touch!
                  </p>
