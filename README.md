# Ashif-Portfolio — Developer Portfolio
...
**Live Demo:** [https://ashif-ansari.vercel.app](https://ashif-ansari.vercel.app)
...
├── projects/
│   └── ashif/                    # ← DROP YOUR PROJECTS HERE (rename "ashif" to your name)
│       ├── Day 1/
...
```bash
git clone https://github.com/ashif-45/ashif-portfolio.git
cd ashif-portfolio
```
...
The scanner looks for projects inside `projects/ashif/`. Rename the `ashif` folder to your own name (or any label you prefer), then update the path in two places:
...
4. Rename `projects/ashif/` → `projects/your-name/` and update the path in `projectScanner.ts` and `build-all.cjs`
