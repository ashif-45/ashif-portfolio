...
export const metadata: Metadata = {
  title: "Ashif Ansari — Full Stack Developer",
  description: "Portfolio of Ashif Ansari — Full Stack Developer specializing in React, Next.js, Java and Spring Boot.",
  keywords: ["Full Stack Developer", "React Developer", "Next.js", "Java", "Spring Boot", "Ashif Ansari"],
  authors: [{ name: "Ashif Ansari" }],
  openGraph: {
    title: "Ashif Ansari — Full Stack Developer",
    description: "Portfolio of Ashif Ansari — Full Stack Developer specializing in React, Next.js, Java and Spring Boot.",
    type: "website",
