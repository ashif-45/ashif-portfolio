                    ...
                    <div className="flex flex-col items-center justify-center py-32 gap-6 text-center animate-fade-in">
                        ...
                        <div>
                            ...
                            <p className="text-slate-400 dark:text-slate-500 mt-2 max-w-sm">
                                Paste your <span className="font-mono text-brand-500">ashif/</span> folder inside{" "}
                                <span className="font-mono text-brand-500">ashif-portfolio/projects/</span> to get started.
                            </p>
                        </div>
                    </div>
                ) : (
