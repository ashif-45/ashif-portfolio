                        ...
                        {submitted ? (
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                                ...
                                <div>
                                    ...
                                    <textarea name="message" value={form.message} onChange={handleChange} required rows={5} placeholder="Hi Ashif, I'd love to connect..." className={`${inputClass} resize-none`} />
                                </div>
                                <button
                                    type="submit"
