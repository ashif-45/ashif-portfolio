      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <span>Ashif<span className="text-brand-500">.</span>dev</span>
            </Link>
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed max-w-xs">
              Full Stack Developer building modern web applications with Jave, Spring Boot and React.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-border-light dark:border-border-dark flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-slate-400 dark:text-slate-500">
            © {new Date().getFullYear()} Ashif Ansari. All rights reserved.
          </p>
          <p className="text-xs text-slate-400 dark:text-slate-500">
